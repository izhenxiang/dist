...
function zt() {
	return !yr() && Object.prototype.toString.call(
...
var Or = Object.setPrototypeOf || ({ __proto__: [] } instanceof Array ? xr : Rr);
function xr(t, e) {
...
var S = function (t) {
	...
	function e(r) {
		...
		return (
			i.message = r, i.name = n.prototype.constructor.name, Or(i, n.prototype), i
		);
	}
	return e;
}(Error),
...
function Gt(t) {
	var e = typeof t == "string" ? Pr(t) : Re(t);
	return (Lr(e), e);
}
var jr = ["fatal", "error", "warning", "log", "info", "debug", "critical"],
	G = y(),
	bt = "Sentry Logger ",
	Ie = ["debug", "info", "warn", "error", "log", "assert"];
function ft(t) {
	var e = y();
	if (!("console" in e)) {
		return t();
...
function zr() {
	("console" in _) && Ie.forEach(function (t) {
		(t in _.console) && b(
			_.console,
			t,
			function (e) {
	...
	!Ur() || b(
		...
		function (t) {
			return function () {
				...
				var n = {
					args: e,
					fetchData: { method: Wr(e), url: Gr(e) },
	...
	return (
		e === void 0 && (e = !1), function (r) {
			if (!(!r || st === r) && !Qr(r)) {
				...
				at === void 0 ? (t({ event: r, name: n, global: e }), st = r) : Vr(
					st,
					r,
...
function vn(t, e) {
	...
	var n = Date.parse("" + t);
	return isNaN(n) ? hn : n - e;
}
function Fe(t, e) {
	return t[e] || t.all || 0;
}
function gn(t, e, r) {
	return (r === void 0 && (r = Date.now()), Fe(t, e) > r);
}
function _n(t, e, r) {
	var n, i, o, a;
	r === void 0 && (r = Date.now());
...
function E() {
	var t = mt();
	return (
		(!Ae(t) || P(t).isOlderThan(Vt)) && Qt(t, new yt()), zt() ? Sn(t) : P(t)
	);
}
function Sn(t) {
	try {
...
function qe(t, e) {
	return "" + He(t) + t.projectId + "/" + e + "/";
}
function Ye(t) {
	return Mr({ sentry_key: t.publicKey, sentry_version: Ln });
}
function jn(t) {
	return qe(t, "store");
}
...
function Dn(t) {
	return qe(t, "envelope");
}
function Zt(t, e) {
	return e || Dn(t) + "?" + Ye(t);
}
function Mn(t, e) {
	var r = Gt(t), n = He(r) + "embed/error-page/", i = "dsn=" + et(r);
			...
			t.prototype.captureException =
				...
				function () {
					this._isEnabled() &&
						...
						(this._integrations = An(this._options));
				}, t.prototype.getIntegration =
				function (e) {
					try {
...
function zn(t, e) {
	var r = te(e),
		...
		s = a.method,
		c = a.rate;
	Hn(t, e.metadata.sdk), t.tags = t.tags || {}, t.extra = t.extra || {}, (
	...
	var l = { body: f, type: n, url: i ? Zt(e.dsn, e.tunnel) : ze(e.dsn) };
	if (i) {
		var v = u(
			u(
				{ event_id: t.event_id, sent_at: new Date().toISOString() },
...
var _e = "6.19.2",
	...
	Xn = [/^Script error\.?$/, /^Javascript error: Script error\.? on line 0$/],
	Ge = function () {
		function t(e) {
...
function Jn(t, e) {
	return (
		t === void 0 && (t = {}), e === void 0 && (e = {}), {
			...
			ignoreErrors: m(t.ignoreErrors || [], e.ignoreErrors || [], Xn),
			ignoreInternal: t.ignoreInternal !== void 0 ? t.ignoreInternal : !0,
		}
	);
}
function Kn(t, e) {
	return e.ignoreInternal && ei(t)
		? (
			p() && h.warn(
...
var ri = Object.freeze(
	Object.defineProperty(
		{ __proto__: null, FunctionToString: We, InboundFilters: Ge },
		Symbol.toStringTag,
		{ value: "Module" },
	),
),
...
var ui = /^\s*at (?:(.*?) ?\((?:address at )?)?((?:file|https?|blob|chrome-extension|address|native|eval|webpack|<anonymous>|[-a-z]+:|.*bundle|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
	ci = /\((\S*)(?::(\d+))(?::(\d+))\)/,
	fi = function (t) {
		var e = ui.exec(t);
		if (e) {
			...
			var i = k(Xe(e[1] || W, e[2]), 2), o = i[0], a = i[1];
	...
	pi = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i,
	hi = function (t) {
		var e, r = di.exec(t);
		if (r) {
	...
	yi = [ai, _i],
	mi = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i,
	Si = function (t) {
		var e = mi.exec(t);
		return e ? rt(e[2], e[3] || W, +e[1]) : void 0;
	},
	Ei = [ni, Si],
	bi = / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^)]+))\(.*\))? in (.*):\s*$/i,
	wi = function (t) {
		var e = bi.exec(t);
...
function Je(t) {
	var e = ee(t), r = { type: t && t.name, value: Ri(t) };
	return (
...
function Rt(t) {
	return { exception: { values: [Je(t)] } };
}
function ee(t) {
	var e = t.stacktrace || t.stack || "", r = xi(t);
	try {
		return Ar(Ei, Ti, li, yi, vi)(e, r);
	} catch {}
	return [];
}
...
function re(t, e, r, n) {
	...
	if (q(t) || $t(t)) {
		var f = t;
		return (i = ki(f, e, n), V(i, { synthetic: !0 }), i);
	}
...
var Nt = y(),
	Ve = function () {
		function t(e) {
			var r = this;
			this.options = e, this._buffer = sn(30), this._rateLimits = {}, this._outcomes =
				{}, this._api = Ht(e.dsn, e._metadata, e.tunnel), this.url =
				ze(this._api.dsn), this.options.sendClientReports &&
				Nt.document &&
		...
		return (
			t.prototype.sendEvent =
				function (e) {
					return this._sendRequest(zn(e, this._api), e);
				}, t.prototype.sendSession =
				function (e) {
...
` + JSON.stringify(e, null, 2),
						...
						var r = Zt(this._api.dsn, this._api.tunnel),
							...
							i = pn(n, this._api.tunnel && et(this._api.dsn));
						try {
							Pi(r, Kt(i));
						} catch (o) {
							p() && h.error(o);
				...
				function (e) {
					var r = e.requestType,
						...
						s = fn(n.status);
					if (
						this._rateLimits = _n(this._rateLimits, i), this._isRateLimited(r) &&
							p() &&
							p() &&
							h.warn(
								"Too many " +
				...
				function (e) {
					var r = It(e);
					return new Date(Fe(this._rateLimits, r));
				}, t.prototype._isRateLimited =
				function (e) {
					var r = It(e);
					return gn(this._rateLimits, r);
				}, t
		);
	}(),
	Li = function (t) {
	...
	Di = function (t) {
		...
		return (
			e.prototype.eventFromException =
				function (r, n) {
					return Ii(r, n, this._options.attachStacktrace);
				}, e.prototype.eventFromMessage =
				function (r, n, i) {
					return (
						n === void 0 && (n = exports.Severity.Info), Ni(
							r,
							n,
							i,
...
function z(t, e, r) {
	...
	Ne(i, t), pt(t, "__sentry_wrapped__", i);
	try {
...
function Ze(t) {
	if (t === void 0 && (t = {}), !!ct.document) {
		...
		e.async = !0, e.src = Mn(t.dsn, t), t.onLoad && (e.onload = t.onLoad);
...
var St = function () {
	function t(e) {
		this.name = t.id, this._installFunc =
			{ onerror: Fi, onunhandledrejection: Ci }, this._options =
...
function Fi() {
	L(
		"error",
		function (t) {
			var e = k(rr(), 2), r = e[0], n = e[1];
			if (!!r.getIntegration(St)) {
				var i = t.msg, o = t.url, a = t.line, s = t.column, c = t.error;
				if (!(Qe() || (c && c.__sentry_own_request__))) {
					var f = c === void 0 && H(i) ? Bi(i, o, a, s) : tr(
						re(c || i, void 0, n, !1),
						o,
						a,
						s,
					);
					f.level = exports.Severity.Error, er(r, c, f, "onerror");
				}
			}
		},
	);
	...
	L(
		...
		function (t) {
			...
			if (!!r.getIntegration(St)) {
				...
				var o = tt(i) ? Ai(i) : re(i, void 0, n, !0);
				o.level = exports.Severity.Error, er(r, i, o, "onunhandledrejection");
			}
		},
	);
}
			...
			t.prototype.setupOnce =
				function () {
					...
					this._options.setTimeout && b(e, "setTimeout", Se), this._options.setInterval && b(
						...
						("XMLHttpRequest" in e) &&
						b(XMLHttpRequest.prototype, "send", Yi);
					var r = this._options.eventTarget;
					if (r) {
						var n = Array.isArray(r) ? r : Hi;
						n.forEach(zi);
					}
				}, t.id = "TryCatch", t
		);
...
var ne = function () {
	...
	return (
		t.prototype.addSentryBreadcrumb =
			...
			function () {
				this._options.console && L("console", Wi), this._options.dom && L(
					"dom",
					$i(this._options.dom),
				), this._options.xhr && L("xhr", Gi), this._options.fetch && L(
					"fetch",
					Xi,
				), this._options.history && L("history", Ji);
			}, t.id = "Breadcrumbs", t
	);
}();
function $i(t) {
...
var Ki = "cause",
	...
	ir = function () {
		function t(e) {
			e === void 0 && (e = {}), this.name = t.id, this._key = e.key || Ki, this._limit =
				e.limit || Vi;
		}
		return (
			t.prototype.setupOnce =
				function () {
					_t(
						function (e, r) {
							...
							return n ? Qi(n._key, n._limit, e, r) : e;
						},
					);
				}, t.id = "LinkedErrors", t
		);
...
function Qi(t, e, r, n) {
	...
	var i = or(e, n.originalException, t);
...
function Zi(t, e) {
	return e ? !!(to(t, e) || eo(t, e)) : !1;
}
function to(t, e) {
	var r = t.message, n = e.message;
	return !(
		(!r && !n) || (r && !n) || (!r && n) || r !== n || !cr(t, e) || !ur(t, e)
	);
}
function eo(t, e) {
	var r = Ee(e), n = Ee(t);
			...
			e.prototype.showReportDialog =
				function (r) {
					...
					if (!!n) {
						...
						Ze(u(u({}, r), { dsn: r.dsn || this.getDsn() }));
					}
...
function no(t) {
	...
	), Gn(fr, t), t.autoSessionTracking && ao();
}
function io(t) {
	t === void 0 && (t = {});
...
var dr = {}, Pt = y();
Pt.Sentry && Pt.Sentry.Integrations && (dr = Pt.Sentry.Integrations);
var so = u(u(u({}, dr), ri), ro);
const Lt = "sentry-ipc";
var K;
(function (t) {
...
var Te;
(function (t) {
	t[t.Classic = 1] = "Classic", t[t.Protocol = 2] = "Protocol", t[t.Both = 3] =
		"Both";
})(Te || (Te = {}));
function uo(t) {
...
const hr = [...lr, new nt(), new it()];
function lo(t = {}) {
	if (uo("renderer"), window != null && window.__SENTRY__RENDERER_INIT__) {
		h.warn(
...
If init has been called in the preload and contextIsolation is disabled, is not required to call init in the renderer`,
	...
	), t.defaultIntegrations === void 0 && (t.defaultIntegrations = hr), t.dsn === void 0 && (
		t.dsn = "https://12345@dummy.dsn/12345"
	), delete t.initialScope, no(t);
}
const po = Object.assign(Object.assign({}, fo), so);
exports.BrowserClient = fr;
exports.Hub = yt;
exports.Integrations = po;
exports.Scope = Q;
exports.addBreadcrumb = Tn;
exports.addGlobalEventProcessor = _t;
exports.captureEvent = bn;
exports.captureException = Be;
exports.captureMessage = En;
exports.configureScope = wn;
exports.defaultIntegrations = hr;
exports.getCurrentHub = E;
exports.getHubFromCarrier = P;
exports.init = lo;
exports.injectReportDialog = Ze;
exports.lastEventId = oo;
exports.setContext = kn;
exports.setExtra = Rn;
exports.setExtras = On;
exports.setTag = In;
exports.setTags = xn;
exports.setUser = Nn;
exports.showReportDialog = io;
exports.startTransaction = Pn;
exports.withScope = Ue;
